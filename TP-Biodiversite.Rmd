...
Le [support de cours](https://ericmarcon.github.io/MesuresBioDiv2/) et son [diaporama](https://ericmarcon.github.io/MesuresBioDiv2/) sont en ligne.
...
Les données sont obligatoirement les fréquences des abondances, c'est-à-dire le nombre d'espèces représentées par chaque nombre d'indivdus.
```{r SPECIES, exercise=TRUE, hint=TRUE}
library("SPECIES")
...
Les valeurs de traits individuels proviennent des projets Bridge et sont complétés par des valeurs moyennes par espèce de la littérature compilées dans la base Mariwenn.
...
quiz(
  ...
  question("La diversité phylogénétique est la moyenne le long de l'arbre de la diversité à chaque période",
    answer("Vrai", correct = TRUE),
    answer("Faux : c'est vrai pour l'entropie, mais la transformation en diversité n'est pas linéaire"),
